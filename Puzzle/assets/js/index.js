...
function renderGameLevels(localGameDataObject, board) {
    ...
    document.querySelector('.board').classList.add('board_tile_choose');
    board.innerHTML = '';
    let levelClassName = '';
    ...
    if (board.lastChild.getAttribute('data-level') === '6' &&
        board.lastChild.textContent !== '6x6') {
...
function startGame(props) {
    ...
    document.querySelector('.board').classList.remove('board_tile_choose');
